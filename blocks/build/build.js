...
var Profile = function (_Component) {
	...
	function Profile(props) {
		...
		var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Profile.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(Profile)).apply(this, arguments));

		_this.changeEvent = _this.changeEvent.bind(_this);
		_this.fetchReq = _this.fetchReq.bind(_this);
		return _this;
	}
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Profile, [{
		...
		value: function render() {
			return wp.element.createElement(
				...
				wp.element.createElement("input", { type: "text", className: "abcd", value: this.props.attributes.inputString, onChange: this.changeEvent }),
				wp.element.createElement(
					"h3",
					null,
					this.props.attributes.title
				),
				wp.element.createElement("img", { src: this.props.attributes.url })
			);
		}
	}]);
